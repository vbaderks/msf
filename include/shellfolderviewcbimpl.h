...
public:
    ...
    STDMETHOD(MessageSFVCB)(UINT uMsg, WPARAM wParam, LPARAM lParam)
    {
        try
        {
            ...
            {
            case SFVM_MERGEMENU:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnMergeMenu)\n"));
                return static_cast<T*>(this)->OnMergeMenu(reinterpret_cast<QCMINFO*>(lParam));

            case SFVM_INVOKECOMMAND:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnInvokeCommand, idCmd = %d)\n"), wParam);
                return static_cast<T*>(this)->OnInvokeCommand(static_cast<unsigned int>(wParam));

            case SFVM_GETHELPTEXT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetHelpText, idCmd = %d)\n"), LOWORD(wParam));
            ...
            case SFVM_GETTOOLTIPTEXT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetToolTipText)\n"));
            ...
            case SFVM_GETBUTTONINFO:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetButtonInfo)\n"));
                return static_cast<T*>(this)->OnGetButtonInfo(reinterpret_cast<TBINFO*>(lParam));

            case SFVM_GETBUTTONS:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetButtons)\n"));
            ...
            case SFVM_INITMENUPOPUP:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnInitMenuPopup)\n"));
            ...
            case SFVM_GETNAMELENGTH: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetNameLength)\n"));
                break;

            case SFVM_EXITMENULOOP: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnExitMenuLoop)\n"));
                break;

            case SFVM_FSNOTIFY:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnFSNotify)\n"));
                return static_cast<T*>(this)->OnFSNotify(reinterpret_cast<LPCITEMIDLIST>(wParam), static_cast<DWORD>(lParam));

            case SFVM_WINDOWCREATED:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnWindowCreated hwnd=%d)\n"), wParam);
                return static_cast<T*>(this)->OnWindowCreated(reinterpret_cast<HWND>(wParam));

            case SFVM_GETDETAILSOF:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetDetailsOf, iColumn = %d)\n"), wParam);
                return static_cast<T*>(this)->OnGetDetailsOf(static_cast<int>(wParam), reinterpret_cast<DETAILSINFO*>(lParam));

            case SFVM_COLUMNCLICK:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnColumnClick, column=%d)\n"), wParam);
                return static_cast<T*>(this)->OnColumnClick(static_cast<unsigned int>(wParam));

            case SFVM_QUERYFSNOTIFY:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnQueryFSNotify)\n"));
                return static_cast<T*>(this)->OnQueryFSNotify(reinterpret_cast<SHChangeNotifyEntry*>(lParam));

            case SFVM_DEFITEMCOUNT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnDefItemCount)\n"));
                return static_cast<T*>(this)->OnDefItemCount(reinterpret_cast<UINT*>(lParam));

            case SFVM_DEFVIEWMODE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnDefViewMode)\n"));
                return static_cast<T*>(this)->OnDefViewMode(reinterpret_cast<FOLDERVIEWMODE*>(lParam));

            case SFVM_UNMERGEMENU:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUnmergeMenu)\n"));
                return static_cast<T*>(this)->OnUnmergeMenu(reinterpret_cast<HMENU>(lParam));

            case SFVM_UPDATESTATUSBAR:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUpdateStatusbar)\n"));
                return static_cast<T*>(this)->OnUpdateStatusbar(static_cast<BOOL>(wParam));

            case SFVM_BACKGROUNDENUM:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnBackgroundEnum)\n"));
                return static_cast<T*>(this)->OnBackGroundEnum();

            case SFVM_DIDDRAGDROP:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnDidDragDrop)\n"));
                return static_cast<T*>(this)->OnDidDragDrop(static_cast<DWORD>(wParam), reinterpret_cast<IDataObject*>(lParam));

            case SFVM_SETISFV:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnSetInterfaceSiteFolderView, lparam=%p)\n"), lParam);
                return static_cast<T*>(this)->OnSetInterfaceSiteFolderView(reinterpret_cast<IUnknown*>(lParam));

            case SFVM_THISIDLIST:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnThisIDList)\n"));
                return static_cast<T*>(this)->OnThisIDList(reinterpret_cast<LPITEMIDLIST>(lParam));

            case SFVM_ADDPROPERTYPAGES:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnAddPropertyPages)\n"));
                return static_cast<T*>(this)->OnAddPropertyPages(reinterpret_cast<SFVM_PROPPAGE_DATA*>(lParam));

            case SFVM_BACKGROUNDENUMDONE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnBackgroundEnumDone)\n"));
                return static_cast<T*>(this)->OnBackgroundEnumDone();

            case SFVM_GETNOTIFY:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetNotify)\n"));
            ...
            case SFVM_GETSORTDEFAULTS:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetSortDefaults)\n"));
            ...
            case SFVM_SIZE: // Notification that the folder view window has been resized.
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnSize)\n"));
                return static_cast<T*>(this)->OnSize();

            case SFVM_GETZONE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetZone)\n"));
                return static_cast<T*>(this)->OnGetZone(reinterpret_cast<DWORD*>(lParam));

            case SFVM_GETPANE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetPane, paneid=%d)\n"), wParam);
                return static_cast<T*>(this)->OnGetPane(static_cast<int>(wParam), reinterpret_cast<DWORD*>(lParam));

            case SFVM_GETHELPTOPIC:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetHelpTopic)\n"));
            ...
            case SFVM_UNDOCUMENTED56: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUndocumented56)\n"));
                break;

            case SFVM_UNDOCUMENTED60: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUndocumented60)\n"));
                break;

            case SFVM_GETPERSISTHISTORY: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetPersistHistory)\n"));
                break;

            case SFVM_GETANIMATION: // Documented, but not (always) defined in shlobj.h
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetAnimation)\n"));
            ...
            case SFVM_GET_VIEW_DATA: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetViewData)\n"));
                return static_cast<T*>(this)->OnGetViewData(static_cast<FOLDERVIEWMODE>(wParam), reinterpret_cast<BOOL*>(lParam));

            case SFVM_WNDMAIN:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnWndMain)\n"));
                return static_cast<T*>(this)->OnWndMain(reinterpret_cast<HWND>(lParam));

            case SFVM_ENUMERATEDITEMS:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnEnumeratedItems)\n"));
                break;

            case SFVM_GETCOLUMNSTREAM:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetColumnsStream)\n"));
                break;

            case SFVM_WINDOWCLOSING:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnWindowClosing)\n"));
                break;

            case SFVM_ADDINGOBJECT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnAddingObject)\n"));
                break;

            case SFVM_REMOVINGOBJECT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnRemovingObject)\n"));
                break;

            case SFVM_GET_CUSTOMVIEWINFO:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetCustomViewInfo)\n"));
                break;

            case SFVM_WINDOWFOCUSED:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnWindowFocused)\n"));
                break;

            case SFVM_LISTREFRESHED:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnListRefreshed)\n"));
                break;

            case SFVM_VIEWRELEASE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnViewRelease, wparam=%d, lparam=%d)\n"), wParam, lParam);
                break;

            case SFVM_SORT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnSort, wparam=%d, lparam=%d)\n"), wParam, lParam);
                break;

            case SFVM_CREATEVIEWWND2:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnCreateViewWnd2, wparam=%d, lparam=%d)\n"), wParam, lParam);
                break;

            case SFVM_WNDPROC:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnWndProc)\n"));
                break;

            case SFVM_SHOWWEBVIEW:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnShowWebView)\n"));
                break;

            case SFVM_UNDOCUMENTED78:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUndocumented78)\n"));
                break;

            case SFVM_GET_WEBVIEW_LAYOUT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetWebviewLayout)\n"));
                break;

            case SFVM_GET_WEBVIEW_CONTENT:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetWebviewContent)\n"));
            ...
            case SFVM_GET_WEBVIEW_TASKS:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetWebviewTasks)\n"));
                break;

            case SFVM_GET_WEBVIEW_THEME:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetWebviewTheme)\n"));
                break;

            case SFVM_GETEXTVIEWS:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetExtViews)\n"));
                break;

            case SFVM_FINDITEM: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnFindItem, wParam=%p, lParam=%p)\n"), wParam, lParam);
                return static_cast<T*>(this)->OnFindItem(wParam, reinterpret_cast<LPITEMIDLIST>(lParam));

            case SFVM_GET_WEBVIEW_TEMPLATE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetWebViewTemplate)\n"));
                break;

            case SFVM_GET_VIEWINFO_TEMPLATE:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetViewInfoTemplate)\n"));
                break;

            case SFVM_ISSTRICTREFRESH:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnIsStrictRefresh)\n"));
                break;

            case SFVM_UNDOCUMENTED51:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnUndocumented51)\n"));
                break;

            case SFVM_GETCOMMANDDIR: // Undocumented
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnCommandDir)\n"));
                break;

            case SFVM_CANSELECTALL:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnCanSelectAll)\n"));
                break;

            case SFVM_GET_FOLDER_TYPE_DESCRIPTION: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetFolderTypeDescription)\n"));
                break;

            case SFVM_POST_CREATE_VIEW_WINDOW3: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnPostCreateViewWindow3)\n"));
                break;

            case SFVM_PRE_CREATE_VIEW_WINDOW3: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnPreCreateViewWindow3)\n"));
                break;

            case SFVM_GET_EMPTY_TEXT: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetEmptyText)\n"));
                break;

            case SFVM_GET_MAX_ITEM_COUNT: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnGetMaxItemCount)\n"));
                break;

            case SFVM_CANCEL_PENDING_NAV: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnCancelPendingNav)\n"));
                break;

            case SFVM_REGISTER_FOR_CHANGES: // Undocumented, seen on Windows 8
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (OnRegisterForChanges)\n"));
                break;

            default:
                ATLTRACE2(atlTraceCOM, 0, _T("IShellFolderViewCBImpl::IShellFolderViewCB::MessageSFVCB (uMsg=%d (undocumented))\n"), uMsg);
                break;
            }
