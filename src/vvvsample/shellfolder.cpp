...
class ATL_NO_VTABLE ShellFolder :
    ...
    public IItemNameLimitsImpl<ShellFolder, VVVItem>
{
public:
    ...
    {
        return LoadResourceString(IDS_SHELLFOLDER_DFM_HELP_BASE + nCmdId);
    }
    ...
    {
        return CfHDrop::IsFormat(pdataobject);
    }
    ...
    bool UserConfirmsFileDelete(HWND hwnd, const CVVVItemList& items) const
    {
        ...
        else
        {
            strMessage.FormatMessage(IDS_SHELLFOLDER_MULTIPLE_DELETE,
                ToString(static_cast<unsigned int>(items.size())).c_str());
