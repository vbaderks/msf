...
public:
    ...
    BEGIN_COM_MAP(CShellFolder)
        ...
        COM_INTERFACE_ENTRY(IShellFolder)  // included for backwards (win9x) compatiblity (can be removed if not needed).
        COM_INTERFACE_ENTRY(IShellFolder2)
        COM_INTERFACE_ENTRY(IShellDetails) // included for backwards (win9x) compatiblity (can be removed if not needed).
